...
/**
 * Output data for the Blizzard event, representing the outcome and resource changes.
 */
public class BlizzardOutputData {
    ...
    public BlizzardOutputData(String message, int foodChange, int waterChange, int weaponChange, int peopleChange, String inventoryMessage) {
